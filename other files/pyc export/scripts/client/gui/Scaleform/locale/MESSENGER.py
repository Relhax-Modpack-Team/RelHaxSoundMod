...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_CHRISTMASQUESTS = '#messenger:serviceChannelMessages/battleResults/christmasQuests'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_TOYS = '#messenger:serviceChannelMessages/invoiceReceived/toys'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_DEBITEDTOYS = '#messenger:serviceChannelMessages/invoiceReceived/debitedToys'
