...
class MENU(object):
    ...
    def header_account_popover_clan_position(cls, key0):
        outcome = '#menu:header/account/popover/clan/position/{}'.format(key0)
        if outcome not in cls.HEADER_ACCOUNT_POPOVER_CLAN_POSITION_ENUM:
    ...
    @classmethod
    def header_account_popover_crew_position(cls, key0):
        outcome = '#menu:header/account/popover/crew/position/{}'.format(key0)
        if outcome not in cls.HEADER_ACCOUNT_POPOVER_CREW_POSITION_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def header_account_popover_stats(cls, key0):
        outcome = '#menu:header/account/popover/stats/{}'.format(key0)
        if outcome not in cls.HEADER_ACCOUNT_POPOVER_STATS_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def inventory_menu(cls, key0):
        outcome = '#menu:inventory/menu/{}'.format(key0)
        if outcome not in cls.INVENTORY_MENU_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def login_status(cls, key0):
        outcome = '#menu:login/status/{}'.format(key0)
        if outcome not in cls.LOGIN_STATUS_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def profile_stats_blocks(cls, key0):
        outcome = '#menu:profile/stats/blocks/{}'.format(key0)
        if outcome not in cls.PROFILE_STATS_BLOCKS_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def shop_menu_vehicle(cls, key0):
        outcome = '#menu:shop/menu/vehicle/{}'.format(key0)
        if outcome not in cls.SHOP_MENU_VEHICLE_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def shop_table_header_count(cls, key0):
        outcome = '#menu:shop/table/header/count/{}'.format(key0)
        if outcome not in cls.SHOP_TABLE_HEADER_COUNT_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def skilldropwindow_study(cls, key0):
        outcome = '#menu:skillDropWindow/study/{}'.format(key0)
        if outcome not in cls.SKILLDROPWINDOW_STUDY_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def tankmanrecruitrenderer(cls, key0):
        outcome = '#menu:tankmanRecruitRenderer/{}'.format(key0)
        if outcome not in cls.TANKMANRECRUITRENDERER_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def tankmantrainingwindow(cls, key0):
        outcome = '#menu:tankmanTrainingWindow/{}'.format(key0)
        if outcome not in cls.TANKMANTRAININGWINDOW_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def vehicleinfo_params(cls, key0):
        outcome = '#menu:vehicleInfo/params/{}'.format(key0)
        if outcome not in cls.VEHICLEINFO_PARAMS_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def training_info(cls, key0):
        outcome = '#menu:training/info/{}'.format(key0)
        if outcome not in cls.TRAINING_INFO_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def tankmanpersonalcase_modifiers(cls, key0):
        outcome = '#menu:tankmanPersonalCase/modifiers/{}'.format(key0)
        if outcome not in cls.TANKMANPERSONALCASE_MODIFIERS_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def finalstatistic_commonstats_resultlabel(cls, key0):
        outcome = '#menu:finalStatistic/commonStats/resultlabel/{}'.format(key0)
        if outcome not in cls.FINALSTATISTIC_COMMONSTATS_RESULTLABEL_ENUM:
            LOG_WARNING('Localization key "{}" not found'.format(outcome))
            return None
        else:
            return outcome
    ...
    @classmethod
    def nation_tree_title(cls, key0):
