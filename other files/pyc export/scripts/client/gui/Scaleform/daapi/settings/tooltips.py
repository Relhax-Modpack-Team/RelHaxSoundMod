...
TOOLTIPS = {TOOLTIPS_CONSTANTS.TANKMAN: {'tooltip': TOOLTIPS_CONSTANTS.TANKMEN_UI,
 ...
 TOOLTIPS_CONSTANTS.SETTINGS_KEY_RELOAD: {'tooltip': TOOLTIPS_CONSTANTS.SETTINGS_KEY_RELOAD_UI,
                                          ...
                                          'complex': None},
 TOOLTIPS_CONSTANTS.XMAS_TREE: {'tooltip': TOOLTIPS_CONSTANTS.XMAS_TREE_UI,
                                'method': common.XMasTreeTooltipData(contexts.HangarContext()).buildToolTip,
                                'complex': None},
 TOOLTIPS_CONSTANTS.XMAS_INSTRUCTION: {'tooltip': TOOLTIPS_CONSTANTS.XMAS_INSTRUCTION_UI,
                                       'method': common.XMasInstructionTooltipData(contexts.HangarContext()).buildToolTip,
                                       'complex': None},
 TOOLTIPS_CONSTANTS.XMAS_SLOT: {'tooltip': TOOLTIPS_CONSTANTS.XMAS_SLOT_UI,
                                'method': common.XMasSlotTooltipData(contexts.HangarContext()).buildToolTip,
                                'complex': None},
