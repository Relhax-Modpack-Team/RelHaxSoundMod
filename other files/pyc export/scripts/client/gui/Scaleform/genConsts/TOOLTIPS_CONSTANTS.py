...
class TOOLTIPS_CONSTANTS(object):
    ...
    XMAS_TREE = 'xmasTree'
    XMAS_INSTRUCTION = 'xmasInstruction'
    XMAS_SLOT = 'xmasSlot'
    ...
    XMAS_TREE_UI = 'ToolTipInblocksDefaultUI'
    XMAS_INSTRUCTION_UI = 'ToolTipInblocksDefaultUI'
    XMAS_SLOT_UI = 'ToolTipInblocksDefaultUI'
