...
class SoundEffectsId(CONST_CONTAINER):
    ...
    XMAS_GARLAND = 'xmas_garland'
    XMAS_GIFT = 'xmas_gift'
    XMAS_TOY = 'xmas_toy'
    XMAS_TANK_TURRET = 'xmas_tank_turret'
    XMAS_TANK_FRONT = 'xmas_tank_front'
    XMAS_TANK_BOARD = 'xmas_tank_board'
    XMAS_TANK_CAMOUFLAGE = 'xmas_tank_camouflage'
    XMAS_ALCHEMY_CONVERT = 'xmas_alchemy_convert'
    XMAS_AWARD_SHOW = 'xmas_award_show'
    XMAS_RIBBON_SHINE = 'xmas_ribbon_shine'
