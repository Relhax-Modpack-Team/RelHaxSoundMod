...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'tankExpert'): _NationAchieveFactory.get(_as.TankExpertAchievement),
 ...
 (_AB.SINGLE, 'xmasTreeBronze'): _AchieveFactory.get(_as.Achieved),
 (_AB.SINGLE, 'xmasTreeSilver'): _AchieveFactory.get(_as.Achieved),
 (_AB.SINGLE, 'xmasTreeGold'): _AchieveFactory.get(_as.Achieved),
